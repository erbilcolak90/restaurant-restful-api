...
public class OrderService {
    ...
    public Order addProductToOrder(AddProductToOrderInput addProductToOrderInput) {
        Order dbOrder = orderRepository.findByIdAndIsDeletedFalse(addProductToOrderInput.getOrderId()).orElseThrow(CustomException::orderNotFound);
    ...
    public Order deleteProductFromOrder(DeleteProductFromOrderInput deleteProductFromOrderInput){
        Order dbOrder = orderRepository.findByIdAndIsDeletedFalse(deleteProductFromOrderInput.getOrderId()).orElseThrow(CustomException::orderNotFound);
